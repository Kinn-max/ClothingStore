...
if (isset($_POST['submid'])) {
    ...
    $sql = "SELECT * FROM users WHERE (nameUser ='".$nameUser."'  OR email ='".$email."') AND password ='".$password."'";

    $sql_kt = mysqli_query($mysqli,$sql);
    $row = mysqli_fetch_array($sql_kt);
    
    if(mysqli_num_rows($sql_kt)>0){
